    ...
    <div class="container container-custom">
        ...
        <form id="search_form" action="/search">
            <div class="input-group search-input">
                <input id="autocomplete" name="q" type="text" class="form-control"
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 col-xs-12 blog-sidebar">
            ...
            <div class="sidebar-module sidebar-archives sidebar-now-playing">
...
<script>
    ...
    script.onload = function() {
        ...
        autocomplete.setAttribute('src', '/assets/js/jquery.autocomplete.js');
